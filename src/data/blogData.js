export const blogData = [
  {
    id: 1,
    title: "Revolutionizing Digital Solutions: The Journey of New Tech Softs",
    excerpt: "At New Tech Softs, we don't just build software; we architect the future of digital innovation for global businesses.",
  ...
  {
    id: 2,
    title: "Why MERN Stack is the Unrivaled Choice for Startups in 2026",
    excerpt: "Explore why MongoDB, Express, React, and Node.js continue to dominate the development world for modern startups.",
  ...
  {
    id: 3,
    title: "The Rise of Cross-Platform Mastery with Flutter and React Native",
    excerpt: "Developing native-like experiences with a single codebase is no longer a dream. Here's how mobile tech is changing.",
  ...
  {
    id: 4,
    title: "SEO and Digital Marketing: The Secret Sauce for Business Growth",
    excerpt: "Having a great product is not enough if no one can find it. Learn the importance of SEO in the digital economy.",
